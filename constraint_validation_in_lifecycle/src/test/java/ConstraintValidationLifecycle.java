...
public class ConstraintValidationLifecycle {
    ...
    /*
        !IMPORTANT! - This test must have uncommented this line in PersistenceJPAConfigConstraintGroups
    ...
    */
    ...
    public void lifecycle_callbacks_inheritance() {
        System.out.println(" *** Constraints - validation lifecycle***");
