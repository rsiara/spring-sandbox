...
public class Constraints {
    ...
    public void lifecycle_callbacks_inheritance() {
        ...
        employee.setName("John - name exceed 40 chars ababababababababababababababababababababababaababababababababababababababababababababababababababababababaabababababababababababababababababababababababababababababababababababababababababa");
        employee.setId(12);
