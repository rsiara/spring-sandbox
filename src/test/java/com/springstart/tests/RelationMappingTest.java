...
import com.springstart.Service.DatabaseService.ParkingPlaceService;
import com.springstart.Service.DatabaseService.TransactionService;
import com.springstart.Service.DatabaseService.ProjectService;
...
public class RelationMappingTest {
    ...
    private static FinanceUser createNewUser() {
        ...
        financeUser.setState("NY");
        financeUser.setUser_address_line_1("Nowy adres 1");
        financeUser.setUser_address_line_2("Nowy adres 2");
        financeUser.setZip_code("2");
    ...
    public void unidirectionalManyToOne() {
        ...
        System.out.println("Saved Transaction: " + savedTransaction.toString());
    }
    ...
    public void bidirectionalManyToMany() {
        ...
        System.out.println("Project collection second: " + projectCollectionSecond);
    ...
    public void getProjectById() {
        ...
        System.out.println("Get users form project: " + projectService.getById(new Long(25)).getFinanceUsers());
